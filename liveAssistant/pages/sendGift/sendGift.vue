<template>
	<view class="content">
		sendGift
		<img v-if="show_gift==false" src="../../static/imgs/gift.png" alt="" class="sendGift" @click="goSendGift">
		<!-- 礼物 -->
		<view class="giftArea" v-show="show_gift">
			<view class="gift" >
				...
				<view class="tab">
					...
					<image class="closeBtn" @click="goBackPages(5)" src="../../static/imgs/close.png" mode=""></image>
				</view>
		...
		data() {
			return {
				...
				GiftsData:[
					...
					{id:1,tabName:'普通',list:[{giftId:1,name:'花花',icon:'../../static/imgs/gift.png',price:'123'}]},
					{id:2,tabName:'奢华',list:[{giftId:1,name:'花花',icon:'../../static/imgs/gift.png',price:'123'}]}],//tab 
